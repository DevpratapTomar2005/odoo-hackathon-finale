...
CREATE TYPE "attendence_status" AS ENUM('PRESENT', 'ABSENT');--> statement-breakpoint
...
CREATE TYPE "typeoff_unit" AS ENUM('DAY', 'HOUR');--> statement-breakpoint
...
CREATE TABLE "attendences" (
	...
	"status" "attendence_status" DEFAULT 'PRESENT'::"attendence_status" NOT NULL,
...
CREATE TABLE "time_off_types" (
	...
	"unit" "typeoff_unit" DEFAULT 'DAY'::"typeoff_unit" NOT NULL,
...
CREATE INDEX "attendences_employee_id_idx" ON "attendences" ("employee_id");--> statement-breakpoint
...
CREATE INDEX "employees_company_id_idx" ON "employees" ("company_id");--> statement-breakpoint
...
CREATE INDEX "working_schedules_employee_id_idx" ON "working_schedules" ("employee_id");--> statement-breakpoint
ALTER TABLE "allocations" ADD CONSTRAINT "allocations_employee_id_employees_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "attendences" ADD CONSTRAINT "attendences_employee_id_employees_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "employees" ADD CONSTRAINT "employees_manager_id_users_id_fkey" FOREIGN KEY ("manager_id") REFERENCES "users"("id");--> statement-breakpoint
ALTER TABLE "employees" ADD CONSTRAINT "employees_company_id_companies_id_fkey" FOREIGN KEY ("company_id") REFERENCES "companies"("id");--> statement-breakpoint
ALTER TABLE "otps" ADD CONSTRAINT "otps_user_id_users_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "sessions" ADD CONSTRAINT "sessions_user_id_users_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "timeoffs" ADD CONSTRAINT "timeoffs_employee_id_employees_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE;--> statement-breakpoint
...
ALTER TABLE "working_schedules" ADD CONSTRAINT "working_schedules_employee_id_employees_id_fkey" FOREIGN KEY ("employee_id") REFERENCES "employees"("id") ON DELETE CASCADE;